    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Delete groups <span class="caret"></span></a>
                                <ul class="dropdown-menu" id="group-deleter">
                                    <c:forEach items="${groups}" var="group">
                                        <li class="group-delete" id="${group.id}">${group.name}</li>
                                    </c:forEach>
                                </ul>
                            </li>
                        </ul>
        ...
        <script>
            ...
            $('.group-delete').click(function(event){
                var data = {'groupId': event.target.id}
                console.log(data);
